...
[![Skills](https://skillicons.dev/icons?i=c,cs,cpp,python,java,js,ts,linux,ubuntu,debian,centos,windows,powershell,docker,jenkins,githubactions,git,github,ansible,terraform,prometheus,grafana,express,mongodb,mysql,firebase,prisma,postman,nodejs,react,next,tailwind,html,css,figma,ai,ps,arduino,vscode,n8n)](https://skillicons.dev)
